// =============================================================================
// SAT-MSS Shared Types
// Single source of truth for all data model interfaces used by web and api.
// =============================================================================

// -----------------------------------------------------------------------------
// Enums (mirrored from shared-constants — duplicated here for type-only imports)
// -----------------------------------------------------------------------------
...
export type IntersectionCategory =
...
export interface IAuthUser extends IUser {
  // Authenticated user — same as IUser but guaranteed present in req context
}
...
export interface IUpdateCaseFileRequest {
  ...
  evidenceImageIds?: string[]; // ordered array of scene IDs
  evidenceImageCaptions?: Record<string, string>; // sceneId → caption
}
...
export interface IDashboardSummary {
  ...
  deforestationTrend: Array<{ date: string; ha: number }>;
}
...
// Discriminated union for all WS events
export type WsEvent =
  | { event: 'analysis:progress'; payload: IWsAnalysisProgress }
  | { event: 'analysis:complete'; payload: IWsAnalysisComplete }
  | { event: 'analysis:failed'; payload: IWsAnalysisFailed }
  | { event: 'alert:new'; payload: IWsAlertNew }
  | { event: 'notification:new'; payload: IWsNotificationNew }
  | { event: 'export:ready'; payload: IWsExportReady };
